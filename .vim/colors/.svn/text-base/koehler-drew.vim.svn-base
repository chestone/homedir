...
" 	StatusLine	status line of current window; see contrasty.vim
hi StatusLine term=bold,reverse
hi StatusLine cterm=none ctermfg=lightblue ctermbg=white
...
hi StatusLineNC guifg=darkgrey guibg=white
"hi StatusLineNC term=inverse
"hi StatusLineNC cterm=inverse ctermfg=DarkGrey ctermbg=White
